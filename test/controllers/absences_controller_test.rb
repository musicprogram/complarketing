...
class AbsencesControllerTest < ActionController::TestCase
  ...
  test "should create absence" do
    assert_difference('Absence.count') do
      post :create, absence: { absenceType: @absence.absenceType, endTime: @absence.endTime, permision: @absence.permision, startTime: @absence.startTime, total: @absence.total }
    end
  ...
  test "should update absence" do
    patch :update, id: @absence, absence: { absenceType: @absence.absenceType, endTime: @absence.endTime, permision: @absence.permision, startTime: @absence.startTime, total: @absence.total }
    assert_redirected_to absence_path(assigns(:absence))
  end
