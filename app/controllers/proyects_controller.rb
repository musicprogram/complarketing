class ProyectsController < ApplicationController
  ...
  private
    ...
    def proyect_params
      params.require(:proyect).permit(:campaignName_id, :brandName_id, :country_id, :nameEmployee_id, :nameActivity_id, :typeActivity_id, :note_id, :dateActivity_id, :endDateActivity_id, :totalActivity_id)
    end
end
